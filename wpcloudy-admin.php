...
class wpc_options
{
    ...
    public function create_admin_page()
    {
        ...
        <div id="wpcloudy-header">
            <div id="wp-admin-ui-banner">
                ...
                <a target="_blank" href="https://www.seopress.org/" class="button-primary more-info-link"><?php _e('Download for free','wp-cloudy'); ?></a>
            </div>
    ...
    public function wpc_display_wind_unit_callback()
    {
        ...
        $selected = $options['wpc_display_wind_unit'];
